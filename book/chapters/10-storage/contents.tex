...
greșeală frecventă este aplicarea procesului de formatare pe între discul (ex.
...
\begin{screen}[caption={Veirifcarea integrității sistemului de fișiere},label={lst:storage:fsck}]
...
\begin{enumerate}
  \item click dreapta pe intrarea mașinii virtuale în VirtualBox și deschiderea meniului contextul
...
Stickurile USB sunt, în general, montat automat de sistemul de operare.
...
\begin{enumerate}
  ...
  \item formatarea discului - folosind utilitarul \cmd{mkfs.ext4} (liniile
