...
(vezi \labelindexref{Figura}{fig:storage:hdd}\footnote{\url{https://commons.wikimedia.org/wiki/File:Hard\_Drive\_(11644419853).jpg} (CC BY 2.0)}). Astfel HDD-ul este predispus defectării atunci când acesta
...
În \labelindexref{Figura}{fig:storage:sas-sata}\footnote{\url{https://commons.wikimedia.org/wiki/File:SASvsSATA\_Connector.JPG} (CC BY-SA 3.0)} sunt reprezentate cele 2 tipuri
...
\labelindexref{Capitolul}{ch:boot}:
...
versiune minimală a bootloaderului care va încărca sistemul de operare, așa cum am precizat în \labelindexref{Capitolul}{ch:boot}.
...
discului are asociat un număr unic de identificare (\textit{guid}\abbrev{GUID}{Globally Unique Identifier} - \textit{Globally Unique Identifier}), generat aleator și
...
BIOS în sistemele de calcul, despre care am discutat în \labelindexref{Capitolul}{ch:boot}. BIOS și UEFI sunt componente low-level care
