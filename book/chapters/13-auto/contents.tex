...
Pentru a face parsing, comanda read folosește variabila IFS (Input Field
Separator) a shell-ului. Aceasta este în mod implicit inițializată la caractere
albe (spațiu, tab, linie nouă). Dacă dorim să folosim alt separator, vom
actualiza variabila IFS ca mai jos:
