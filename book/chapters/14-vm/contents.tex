...
\footnote{\url{https://curs.upb.ro/}}, ca în \labelindexref{Figura}{fig:vm:openstack-project}. Odată
...
Autentificarea în cadrul unei mașini virtuale se face folosind chei SSH, așa cum am prezentat în \labelindexref{Secțiunea}{sec:sec:ssh}. Acest mod de autentificare asigură cel mai înalt grad de securitate fiind folosit și de Amazon EC2 în mod implicit.
