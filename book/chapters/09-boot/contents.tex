...
numit BIOS (sau UEFI \abbrev{UEFI}{Unified Extensible Firmware Interface} - \textit{Unified Extensible Firmware Interface}) pe
...
modul nativ de bootare UEFI. UEFI folosește o partiție dedicată numită ESP \abbrev{ESP}{EFI System Partition} (\textit{EFI
...
Datorită flexibilității, sistemele PC \abbrev{PC}{Personal Computer} (\textit{Personal Computer}) moderne
...
sistemului. Pe arhitectura x86, de fapt pe sistemele de tipul PC, acest firmware de boot este BIOS-ul, iar în ultimii ani UEFI.
...
multe despre certificate digitale vom vorbi în \labelindexref{Capitolul}{ch:sec}.
...
În cazul UEFI, partiția ESP conține fișiere executabile
...
intrarea în bootloader, sau folosim un USB stick bootabil sau CD-ROM \abbrev{CD-ROM}{Compact Disc - Read-Only Memory} (\textit{Compact Disc - Read-Only Memory}) sau DVD-ROM \abbrev{DVD-ROM}{Digital Video Disc - Read-Only Memory} (\textit{Digital Video Disc - Read-Only Memory}). În
