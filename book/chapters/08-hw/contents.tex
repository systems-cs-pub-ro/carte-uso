...
\begin{itemize}
	\item x86 are o arhitectură modulară în care utilizatorul poate înlocui
		...
		plăcile de procesare) pe aceeași plăcuță iar acestea nu pot fi
                schimbate separat. Vom detalia aceste sissteme în \labelindexref{Capitolul}{chapter:embed}.
\end{itemize}
...
preț/performanță foarte bun. După cum am precizat mai sus, laptopul tot
...
controlate de un o componentă software specializată: \textbf{sistemul de operare}.
...
introdus, ce opțiuni de configurare oferă, sunt prezentate în \labelindexref{Capitolul}{chapter:boot}.
...
driverele). Așadar recomandăm instalarea ultimelor versiuni de drivere pentru
...
vom descrie procedeele de comunicație între dispozitive și procesor.
...
achiziția unei plăci video (sau mai poartă denumirea de placă grafică - GPU, \textit{Graphical Porcessing Unit}) trebuie avute în vedere următoarele
...
În \labelindexref{Figura}{fig:hw:audio} este reprezentată o placă de rețea 3Com cu interfață RJ45 cu viteza 100mbps.
...
Fiecare arhitectură (x86, ARM) și fiecare format constructiv (server, desktop, laptop, embedded) sunt destinate unui anumit caz de utilizare.
...
Sistemele de operare moderne oferă utilitare și interfețe dedicate pentru investigarea componentelor hardware și driverelor.
