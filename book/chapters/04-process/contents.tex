...
\begin{figure}[!htbp]
	...
	\def\svgwidth{0.8\textwidth}
        \includesvg{chapters/04-process/img/placeholder.svg}
...
\abbrev{PID}{Process Id}. Prezentăm mai multe despre atributele unui proces,
...
\begin{figure}[!htbp]
	\centering
        \includegraphics[width=0.8\textwidth]{chapters/04-process/img/screenshot.png}
...
Sunt prezentate respectiv în \labelindexref{Figura}{fig:process-top}, \labelindexref{Figura}{fig:process-htop}, \labelindexref{Figura}{fig:process-task-manager}, \labelindexref{Figura}{fig:process-process-explorer} screenshot-uri cu utilitarele top, htop, Task Manager și
...
\end{figure}
TODO: screenshot cu Task Manager și afectarea priorității
...
TODO
\end{screen}
TODO:snippet-uri de comenzi de interacțiune: bg, fg, jobs
...
TODO
\end{screen}
TODO: exemplu cu enumerare pași cu pornire emacs, Ctrl+z și bg
...
TODO
\end{screen}
TODO: exemplu cu parent child din codul sursă

Apoi din alt terminal urmărim cele două procese și observăm că procesul copil (\texttt{child}) cu PID-ul TODO are ca părinte procesul părinte (\texttt{parent}) cu PID-ul TODO. Apoi omorâm procesul părinte și investigăm din nou procesul copil. Observăm că acum procesul părinte este procesul \texttt{init} cu PID-ul TODO.
...
%        \def\svgwidth{0.8\textwidth}
%        \includesvg{chapters/04-process/img/placeholder.svg}
%        \caption{Eliberarea unui descriptor de fișîer
...
TODO
\end{screen}
TODO: exemplu cu sleep și redirectări și lsof
...
TODO
\end{screen}
TODO: exemplu care folosește kill
...
TODO
\end{screen}
TODO: exemplu cu grep

\begin{screen}
TODO
\end{screen}
TODO: exemple din arhivă cu programe scrise în C care se încheie în diferite moduri
...
exemplu semnalul \texttt{SIGTSTP} suspendă un proces (și îl trece în background), iar
semnalul \texttt{SIGTERM} îl omoară:

\begin{screen}
TODO
\end{screen}
TODO: snippet cu kill -STP și kill -TERM

Un semnal este identificat de un număr sau de un nume. Atunci când se folosește
la comanda \cmd{kill} poate fi folosit atât numele cât și numărul:

\begin{screen}
TODO
\end{screen}
TODO: snippet cu kill -l
TODO: snippet cu kill -KILL și kill -9
...
în cazul semnalului \texttt{SIGTSTP} și omorârea procesului în cazul \texttt{SIGTERM}. Aceată
...
TODO
\end{screen}
TODO: exemple de folosire operatori de înlănțuire (practice, utile)
...
TODO
\end{screen}
TODO: exemplu practic și util cu comm1 > f ; comm2 < f
...
TODO
\end{screen}
TODO: același exemplu practic și util cu comm1 | comm2
...
TODO
\end{screen}
TODO: exemplu de comandă utilă cu mai multe pipe-uri
...
linere în \labelindexref{Secțiunea}{sec:cli-one-liners}.
...
\end{screen}
TODO: Exemplu cu tty
TODO: Exemplu cu ps cu afișarea terminalului
...
TODO
\end{screen}
TODO: exemplu de rulare ps cu afișarea terminalului pentru un proces shell și pentru
...
TODO
\end{screen}
TODO: rulare comandă ps -{}-tty ? -{}-ppid 1 (ceva de genul)
...
TODO
\end{screen}
TODO: exemplu rulare nohup, afișare descriptori
...
semnalul \texttt{SIGHUP}, pe când comanda disown afectează shell-ul și nu trimite
...
TODO
\end{screen}
TODO: exemplu simplu cu tmux, tmux -ls
...
\begin{center}
	...
	\midrule
          creare fereastră nouă & \texttt{Ctrl+b c} & \texttt{} & \texttt{Ctrl+a c} \\
	\midrule
          detașare & \texttt{Ctrl+b d} & \texttt{} & \texttt{Ctrl+b c} \\
	\midrule
          listare sesiuni & \texttt{tmux list-session} & \texttt{} & \texttt{screen -ls} \\
	\midrule
          reatașare sesiune & \texttt{tmux attach $[$sessio-name$]$} & \texttt{} & \texttt{screen -r $[$session-id$]$} \\
	\midrule
          schimbare fereastră & \texttt{Ctrl+b \textless{}window-id>} & \texttt{} & \texttt{Ctrl+a \textless{}window-id>} \\
	\midrule
          închidere sesiune & \texttt{Ctrl+b TODO} & \texttt{} & \texttt{Ctrl+a \textbackslash{}} \\
	\bottomrule
	\end{tabular}
        \label{table:process-attributes}
\end{center}
...
TODO
\end{screen}
TODO: exemplu de folosire iotop
...
TODO
\end{screen}
TODO: exemple de folosire ltrace/strace
...
%\end{figure}
%TODO: diagramă cu acțiunile unui loader
