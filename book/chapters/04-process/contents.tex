...
detaliu în \labelindexref{Secțiunea}{sec:process-interactivitate-daemon}.
...
vedea în \labelindexref{Secțiunea}{sec:process-ierarhie-foreground-background}.
...
între procese în \labelindexref{Secțiunea}{sec:process-operatii}. Interacțiunea
între procese.
...
\begin{itemize}
	...
	\item mecanisme explicite de comunicare între procese: procesele
		comunică între ele pentru realizarea unei acțiuni mai complexe.
                Vom discuta în \labelindexref{Secțiunea}{sec:process-operatii-semnale}, respectiv \labelindexref{Secțiunea}{sec:process-operatii-pipe} despre semnale și pipe-uri,
...
utilizate se găsesc în \labelindexref{Secțiunea}{sec:process-investigare}.
...
proceselor vom prezenta în \labelindexref{Secțiunea}{sec:process-investigare}.
...
\begin{itemize}
  ...
  \item \cmd{lsof} (\textit{list open files}) este utilitarul care afișează
		...
		\labelindexref{Secțiunea}{sec:process-fisiere}
\end{itemize}
...
prezentăm în \labelindexref{Secțiunea}{sec:process-ierarhie-init}.
...
detalii în \labelindexref{Secțiunea}{sec:process-ierarhie-init}.
...
\labelindexref{Secțiunea}{sec:process-interactivitate-daemon}
...
\labelindexref{Secțiunea}{sec:process-operatii-pipe}.
...
\labelindexref{Secțiunea}{sec:process-operatii-semnale}.
...
\labelindexref{Secțiunea}{sec:process-ierarhie-foreground-background} procesul
...
Am prezentat exemple și screenshot-uri de folosire a acestor utilitare în \labelindexref{Secțiunea}{sec:process-resurse-atribute}.
...
\labelindexref{Secțiunea}{sec:process-fisiere} Pentru monitorizarea folosirii
